...
function Impressum() {
    return (
        <div>
            <Typography variant='h4' gutterBottom={true}>Impressum</Typography>        
   
            <Typography gutterBottom={true}>Angaben gemäß § 5 TMG:<br/><br/>
            Kasperlino GmbH <br/>
            Grafenberger Allee 277-287 <br/>           
            40237 Düsseldorf       <br/><br/>
            Ust.-ID-Nr.: DE323782550   <br/>         
            Telefon: 0211 436912303  <br/>
            E-Mail: kontakt@kasperlino.de
           </Typography >            

           <Typography variant='h4' gutterBottom={true}>Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV:</Typography>
          ...
          40237 Düsseldorf<br/>  
            ...
            <Typography variant='h4' gutterBottom={true}>1. Inhalt des Onlineangebotes</Typography>  
            <Typography gutterBottom={true}>  Die Inhalte unserer Seiten wurden mit größter Sorgfalt erstellt. 
            ...
            zu löschen oder die Veröffentlichung zeitweise oder endgültig einzustellen.</Typography>
         

           <Typography variant='h4' gutterBottom={true}> 2. Verweise und Links</Typography>
            <Typography gutterBottom={true}> Bei direkten oder indirekten Verweisen auf fremde Webseiten (“Hyperlinks”), die außerhalb des Verantwortungsbereiches des Autors liegen, 
            ...
            die Nutzung im Falle rechtswidriger Inhalte zu verhindern. Der Autor erklärt hiermit ausdrücklich, 
            ...
            haftet allein der Anbieter der Seite, auf welche verwiesen wurde, nicht derjenige, der über Links auf die jeweilige Veröffentlichung lediglich verweist.</Typography>
            <Typography variant='h4'gutterBottom={true}>3. Urheber- und Kennzeichenrecht</Typography>
            <Typography gutterBottom={true}>Der Autor ist bestrebt, in allen Publikationen die Urheberrechte der verwendeten Bilder,
            Grafiken, Tondokumente, Videosequenzen und Texte zu beachten, von ihm selbst erstellte Bilder, 
            Grafiken, Tondokumente, Videosequenzen und Texte zu nutzen oder auf lizenzfreie Grafiken, Tondokumente, Videosequenzen und Texte zurückzugreifen. 
            ...
            Sollten Sie dennoch auf eine Urheberrechtsverletzung aufmerksam werden, bitten wir um eine Benachrichtigung. 
            Bei Kenntnis von Urheberrechtsverletzungen werden wir die betreffenden Inhalte umgehend entfernen.
            ...
            in anderen elektronischen oder gedruckten Publikationen ist ohne ausdrückliche Zustimmung des Autors nicht gestattet.</Typography>
            
            <Typography variant='h4' gutterBottom={true}>Rechtswirksamkeit dieses Haftungsausschlusses</Typography>
            <Typography gutterBottom={true}>
